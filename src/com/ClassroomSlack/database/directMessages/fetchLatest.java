...
public class fetchLatest {
    ...
    public static VBox fetchlatest(String companyName, String threadMailId, String currentUserMailId) {
        ...
        String query = DBUtils.prepareSelectQuery(" * ", "classroomslack.directmessages", "companyName = ? AND ( ( senderEmailId = ? AND receiverEmailId = ? ) OR ( senderEmailId = ? AND receiverEmailId = ? ) )","ORDER BY timestamp asc" );
