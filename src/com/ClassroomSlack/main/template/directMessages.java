...
import com.ClassroomSlack.database.directMessages.addNewMessage;
import com.ClassroomSlack.database.directMessages.fetchLatest;
import com.ClassroomSlack.database.directMessages.keywordSearch;
...
public class directMessages {
    ...
    public static BorderPane directMessages(String companyName, String threadName, String threadMailId, String currentUserMailId){
        ...
        searchNotice.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            fetchedMessages.getChildren().add(keywordSearch.keywordSearch(companyName, threadMailId, currentUserMailId,newValue));
        });
        ...
        fetchedMessages.getChildren().add(fetchLatest.fetchlatest(companyName, threadMailId, currentUserMailId));
